...
declare namespace extensions {
     ...
     */
    function setPermission(bundleId: string, permission: string, value: string): Promise<void>;
    /**
     ...
     */
    function setPermissions(bundleId: string, permissionsMapping: any): Promise<void>;
    /**
     ...
     */
    function getPermission(bundleId: string, serviceName: string): Promise<string>;
}
